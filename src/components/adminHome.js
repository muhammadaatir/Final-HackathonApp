...
// import db from '../navigation/firebaseconfig';
const Home = () => {
    // useEffect(()=>{
        ...
        <View
          ...
          <View style={{flexDirection: 'row'}}>
            <View
              ...
              <Image style={{width: 70, height: 70}} source={require('../../assets/images/user.png')} />
            </View>
            <View style={{marginLeft:20}}>
              <Text style={{ color: '#024f9d',
    fontSize: 25,
    fontWeight: 'bold',}}>Mr.Ahmed</Text>
              <Text style={{ color: '#61b846',
    fontSize: 20,
...
<View style={{flex:8 }}>
        ...
        <FlatList
                ...
                renderItem={({item})=>{
                    return(
                        <View style={{backgroundColor:'#ffffff' , marginLeft:20 ,marginRight:20, width:320 ,flex:1 , flexDirection:'row',justifyContent:'space-around', padding:5,
...
<View style={{ width:90 , marginLeft:10 }}>
    <Image style={{ width:90,height:60 ,marginTop:10}} source={require('../../assets/images/image18.png')}/>
</View>
...
<View style={{backgroundColor:'#F4F3F9' ,
